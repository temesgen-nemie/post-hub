        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">PostHub</span>
            </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li className="text-gray-300">Create Posts</li>
              <li className="text-gray-300">Engage with Community</li>
              <li className="text-gray-300">Real-time Updates</li>
              <li className="text-gray-300">Secure Authentication</li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © 2024 PostHub. All rights reserved.
            </p>
